...
\usepackage{geometry, array, graphicx, wrapfig, float, amsmath, titlesec, amsmath, amsfonts, mathtools, amssymb, colortbl, babel, listings, hyperref, caption}
...
\begin{document}
	...
	\par
	Az is igaz azonban, hogyha nem megfelelően választjuk meg a kulcsokat (pl. többször használunk egy titkosító kulcsot), akkor a titkosítás könnyen törhető. A fő nehézség tehát a one-time pad használatánál, hogy nagy méretű véletlen bitsorozatokat kell előállítani kulcsoknak.
	\par
	...
	Szükséges egy telepített és megfelelően bekonfigurált QT5 keretrendszer mingw73\_64-es platformra. Ez is ingyenesen telepíthető a \url{https://www.qt.io/download} oldalról.
	
	A megfelelően konfiguráltság annyit jelent, hogy könyvtárak és a qmake utai hozzá kell legyenek vannak adva a rendszer PATH környezeti változójához, hogy a program megtalálja a megfelelő .dll fájlokat). Jelen esetben a $<$QT helye$>$ mingw73\_64\textbackslash bin mappát kell hozzáadni a PATH-hoz (a qmake és a .dll-ek egy mappába vannak).
	\subsection{Telepítés}
	Ha a fenti függőségek megfelelően telepítve vannak, akkor telepíthető a program. A Setup mappában található setup.bat script lefuttatja a qmake-t és a make-t, ezzel a program fájljait fordítva és létrehozva a futtatható állományt.
	\subsection{Futattás}
